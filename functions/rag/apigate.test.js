...
// Only `process` and PROVIDER_ORDER are injected, and that is a feature: a new
// `something.secret()` in the health response fails this test on an undefined
// free variable rather than shipping.
